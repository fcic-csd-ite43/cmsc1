                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                                    <strong><?php echo $user['last_name'] . ', ' . $user['first_name']; ?> </strong>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <!--<form role="form"> -->
									<form action="user_add_info.php" method="post" enctype="multipart/form-data" name="frmSaveStudent" id="frmSaveStudent">
										...
										<div class="form-group">
                                            <!--<label>Text Input with Placeholder</label> -->
                                            <input class="form-control" placeholder="Username" name="password" type="text" id="txtUN"  value="">
                                        </div>
										<div class="form-group">
                                            <!--<label>Text Input with Placeholder</label> -->
                                            <input class="form-control" placeholder="Password" name="confirm_password" type="password" id="txtPW"  value="">
                                        </div>
