...
<body>
	...
	<div class="row">
        ...
        <form action="registerUser.php" method="post" enctype="multipart/form-data" name="frmSaveStudent" id="frmSaveStudent">
          <div class="form-group">
            <!--<div class="form-row"> -->
              <!--<div class="col-md-6"> -->
                <label for="exampleInputName">User Name</label>
                <input class="form-control" id="txtFN" name="txtFN" type="text" aria-describedby="nameHelp" placeholder="Enter user name">
        ...
        <div class="text-center">
          ...
          <a class="d-block small" href="email-verification-master/index.php">Forgot Password?</a>
        </div>
      </div>
    </div>
  </div>
