<?php
	if(isset($_POST["reset-password"])) {
		$conn = mysqli_connect("localhost", "id4782439_zcbulawanjr", "thisistheway", "id4782439_cmsc");
...
<h1>Reset Password</h1>
	...
	<a class="d-block small mt-3" href="https://zcbulawanjr.000webhostapp.com/index.php">Login Page</a>
	<?php } ?>
