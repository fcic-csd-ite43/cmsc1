<!DOCTYPE html>
<!--Create page that will warn the users that their email has not yet been verified and get the details to resend the activation codes using send_email.php-->
<html>
	<head>
