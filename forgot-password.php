    ...
    <div class="row">
        ...
        <form action="resetUser.php" method="post">
          <div class="form-group">
            <input class="form-control" id="txtEmail" name="txtEmail" type="email" aria-describedby="emailHelp" placeholder="Enter email address">
          </div>
		  <button type="submit" class="btn btn-lg btn-success btn-block">Reset Password</button>
          <!--<a class="btn btn-lg btn-success btn-block" href="confirmUser.php">Reset Password</a> -->
