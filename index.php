...
<head>
    <!-- Create a sign in page to capture email and password and verify with database if credentials exists with database-->
    <meta charset="utf-8">
        ...
        <div class="row vertical-center-row">
            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <!-- Create links to enable usrs to change passwords if they forget their old password OR create a new account if they still do not have any accounts-->
					<div class="panel-heading">
